            ...
            if xprv != "" {
                ...
                getActiveWallet { (wallet) in
                    ...
                    if wallet != nil {
                        ...
                        self.recoveryText = "bitcoin-cli -rpcwallet=\(wallet!.name) importmulti { \"desc\": \"\(self.privateKeyDescriptor)\", \"timestamp\": \(wallet!.birthdate), \"range\": [0,999], \"watchonly\": false, \"label\": \"StandUp\", \"keypool\": true, \"internal\": false }\n\nbitcoin-cli -rpcwallet=\(wallet!.name) importmulti { \"desc\": \"\(self.privateKeyDescriptor)\", \"timestamp\": \(wallet!.birthdate), \"range\": [1000,1999], \"watchonly\": false, \"keypool\": true, \"internal\": true }"
                        
                        if wallet!.type == "MULTI" {
                            
                            self.recoveryText = "bitcoin-cli -rpcwallet=\(wallet!.name) importmulti { \"desc\": \"\(self.privateKeyDescriptor)\", \"timestamp\": \(wallet!.birthdate), \"range\": [0,1999], \"watchonly\": false, \"label\": \"StandUp\", \"keypool\": false, \"internal\": false }"
                ...
                getActiveWallet { (wallet) in
                    ...
                    if wallet != nil {
                        ...
                        if wallet!.type == "MULTI" {
                            ...
                            self.publicKeyDescriptor = wallet!.descriptor
